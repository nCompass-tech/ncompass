"""
Build script for the optimized HSTU attention kernel (hstu_runner package).
Based on generative_recommenders/ops/cpp/setup.py.
Registers ops under torch.ops.hstu_opt namespace.
"""
...
DISABLE_BACKWARD = True  # Always forward-only for runner
...
DISABLE_SM8x = True  # Always SM90-only for runner
...
setup(
    ...
    description="HSTU FlashAttention Runner (optimized kernel)",
