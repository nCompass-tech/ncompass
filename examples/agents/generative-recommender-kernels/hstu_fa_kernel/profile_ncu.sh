...
#   bash hstu_fa_kernel/profile_ncu.sh --kernel-regex "FlashAttn"      # custom kernel filter
#   bash hstu_fa_kernel/profile_ncu.sh -- --batch-size 256             # pass args to profile_ncu.py
set -euo pipefail
...
OUTPUT_NAME="hstu_scratch_profile"
EXTRA_ARGS=()
